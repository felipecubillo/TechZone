...
class FactoryConexion
{
    ...
    public static string CreateConnection()
    {
        ...
        {
            if (ConfigurationManager.ConnectionStrings[i].Name.Equals("AppProyectoFelipe.Properties.Settings.Cadena", StringComparison.InvariantCultureIgnoreCase))
                existe = true;
        }
        ...
        conexion.AppendFormat("{0}", ConfigurationManager.ConnectionStrings["AppProyectoFelipe.Properties.Settings.Cadena"].ConnectionString);
